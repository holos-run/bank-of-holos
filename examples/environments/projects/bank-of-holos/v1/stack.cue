...
_Stack: {
	...
	Resources: {
		...
		// DEMO:SECRETS:v1 ☞ Replace ConfigMap with an ExternalSecret
		ConfigMap: "demo-data-config": k8s.#ConfigMap & {
			...
			data: {
				...
				// DEMO:SECRETS:v1 ☞ Hard coded password here.
				DEMO_LOGIN_PASSWORD: "bankofanthos"
			}
		}

		// DEMO:SECRETS:v1 ☞ Uncomment ExternalSecret to replace ConfigMap.
